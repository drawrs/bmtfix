<?php $__env->startSection('title', 'Tambah Produk Baitulmaal'); ?>
...
<ol class="breadcrumb">
  ...
  <li class="active">Tambah Baitulmaal</li>
</ol>
<?php $__env->stopSection(); ?>
...
<div class="box-body">
  <form method="post" action="<?php echo e(route('baitulmaal.add')); ?>" enctype="multipart/form-data">
